...
const services: ServiceItem[] = [
  {
    ...
    route: '/services/buy-airtime' as Href,
  },
  {
    id: 2,
    name: 'Data',
    icon: icons.data,
    route: '/services/buy-data' as Href,
  },
  {
    id: 3,
    name: 'Electricity',
    icon: icons.electricity,
    route: '/services/buy-electricity' as Href,
  },
  {
    id: 4,
    name: 'TV',
    icon: icons.television,
    route: '/services/buy-tv' as Href,
  },
  {
    id: 5,
    name: 'Internet',
    icon: icons.internet,
    route: '/services/buy-internet' as Href,
  },
  {
    id: 6,
    name: 'ESims',
    icon: icons.esim,
    route: '/services/buy-esim' as Href,
  },
  {
    id: 7,
    name: 'Betting',
    icon: icons.betting,
    route: '/services/buy-betting' as Href,
  },
  { id: 8, name: 'More', icon: icons.more, route: '/services/more-services' },
];
...
const Home = () => {
  return (
    <SafeAreaView className="flex-1 bg-gray-100 px-4">
      ...
      {/* Balance Card */}
      <View className="bg-green-600 p-4 rounded-2xl mt-4">
